...
4. `formulas` are special functions in OPTIMUS, similar to Excel formulas, where you can perform some calculation and return the corresponding value. Example:    
